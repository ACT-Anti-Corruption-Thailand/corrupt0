...
const GraphCard = (props: GraphCardProps) => {
  return (
    <Link
      ...
      className="bg-white bg-opacity-10 text-gray-4 rounded-5 lg:b4 p-10 lg:p-20 mx-5 my-10 flex flex-row gap-5 lg:gap-20 items-start text-18 w-full no-underline"
    >
